...
def create_previous_month_salaries():
    ...
    for employee in employees:
        ...
        if not Salary.objects.filter(employee=employee, year=previous_year, month=previous_month).exists():
            ...
            total_workdays = calculate_total_workdays(employee, previous_month, previous_year)
            total_leave_days = calculate_total_leave_days(employee, previous_month, previous_year)
            num_days_without_weekend = num_days_in_previous_month - count_weekend_days
            total_salary = calculate_total_salary(employee, total_workdays, previous_month, previous_year, num_days_without_weekend, total_leave_days)
            salary = Salary(
                employee=employee,
...
def calculate_total_salary(employee, total_workdays, previous_month, previous_year, num_days_without_weekend, total_leave_days):
...
def calculate_total_workdays(employee, previous_month, previous_year):
...
def calculate_total_leave_days(employee, previous_month, previous_year):
